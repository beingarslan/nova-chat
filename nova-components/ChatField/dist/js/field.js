...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    groupedMessages: function groupedMessages() {
      var grouped = this.messages.reduce(function (acc, message) {
        // Extract just the date part from the created_at timestamp
        var date = message.created_at.split('T')[0];
        if (!acc[date]) {
          acc[date] = [];
        }
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("/messages/".concat(_this2.resourceId), {
                headers: {
            ...
            case 6:
              ...
              _this2.fromID = data.loggedUserId;
              _context.next = 12;
              break;
            case 11:
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              return fetch("/messages/send", {
                ...
                body: JSON.stringify({
                  body: _this3.newMessage,
                  to_id: _this3.resourceId // The recipient's user ID
                })
              });
            case 4:
              response = _context2.sent;
              if (response.ok) {
                _this3.newMessage = ''; // Clear input after sending
                _this3.fetchMessages(); // Refresh messages to display the new one
              } else {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    sendMessage: function sendMessage() {
      // Add logic to send message to the server
      this.newMessage = '';
    }
  },
  mounted: function mounted() {
    // Logic to load messages and listen for new ones
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.groupedMessages, function (group) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: group.date,
      "class": "message-group"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(group.date), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(group.messages, function (message) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
        key: message.id,
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([message.from_id == $data.fromID ? 'mine' : 'theirs', "message"])
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(message.body), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatTime(message.created_at)), 1 /* TEXT */)], 2 /* CLASS */);
    }), 128 /* KEYED_FRAGMENT */))]);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.messages, function (message) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", {
      key: message.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(message.body), 1 /* TEXT */)]);
...
Nova.booting(function (app, store) {
  app.component('index-chat-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-chat-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-chat-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.chat-messages[data-v-0224618e] {\n    flex-grow: 1;\n    overflow-y: auto;\n    /* Ensures scrolling within the message area */\n    padding: 10px;\n    background-color: #f9f9f9;\n    border: 1px solid #e1e1e8;\n    margin-bottom: 10px;\n    max-height: 400px;\n    /* Adjust based on your needs */\n}\n.message-group[data-v-0224618e] {\n    margin-bottom: 20px;\n}\n.date-divider[data-v-0224618e] {\n    text-align: center;\n    margin-bottom: 10px;\n    color: #888;\n    font-size: 0.9em;\n}\n.chat-container[data-v-0224618e] {\n    display: flex;\n    flex-direction: column;\n    height: 100%;\n}\n.message[data-v-0224618e] {\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 12px;\n    align-items: flex-start;\n}\n.mine[data-v-0224618e] {\n    align-items: flex-end;\n}\n.message-body[data-v-0224618e] {\n    max-width: 60%;\n    color: white;\n    padding: 6px 12px;\n    border-radius: 20px;\n    margin-bottom: 4px;\n    /* Space between message body and time */\n}\n.mine .message-body[data-v-0224618e] {\n    background-color: #007bff;\n}\n.theirs .message-body[data-v-0224618e] {\n    background-color: #28a745;\n}\n.message-time[data-v-0224618e] {\n    font-size: 0.8em;\n    color: #666;\n}\n.send-message[data-v-0224618e] {\n    display: flex;\n}\n.message-input[data-v-0224618e] {\n    flex-grow: 1;\n    margin-right: 10px;\n    padding: 8px;\n    border: 1px solid #ccc;\n    border-radius: 20px;\n}\n.send-button[data-v-0224618e] {\n    padding: 8px 16px;\n    background-color: #007bff;\n    color: white;\n    border: none;\n    border-radius: 20px;\n    cursor: pointer;\n}\n.send-button[data-v-0224618e]:hover {\n    background-color: #0056b3;\n}\n", ""]);
// Exports
...
/* harmony import */ var _Users_coduko_Coduko_Laravel_nova_chat_nova_components_ChatField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/* harmony import */ var _Users_coduko_Coduko_Laravel_nova_chat_nova_components_ChatField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_coduko_Coduko_Laravel_nova_chat_nova_components_ChatField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_FormField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_FormField_vue_vue_type_template_id_c023248a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/FormField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkacme_chat_field"] = self["webpackChunkacme_chat_field"] || [];
